    ...
    <div className={`min-h-screen bg-gradient-subtle ${language === "ar" ? "rtl" : "ltr"}`}>
      ...
      <header className="border-b bg-card/80 backdrop-blur-sm sticky top-0 z-50" role="banner">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex gap-2 sm:gap-3 items-center">
            ...
            <Button
              onClick={() => navigate("/auth")}
              className="bg-blue-700 hover:bg-blue-800 text-white transition-colors touch-target text-sm sm:text-base"
              size="sm"
        ...
        <div className="grid gap-6 sm:gap-8 md:grid-cols-3 max-w-6xl mx-auto">
          <Card className="border-primary/10 hover:border-primary/20 transition-all duration-200 group touch-target">
            <CardHeader className="text-center pb-4">
              <div
                className="w-12 h-12 sm:w-14 sm:h-14 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:bg-primary/20 transition-colors"
                aria-hidden="true"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center max-w-4xl mx-auto">
            ...
            <div className="touch-target">
              <div
                className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-2"
                role="text"
                aria-label="Unlimited consultations"
              >
                ∞
              </div>
      ...
      <footer className="bg-card border-t py-6 sm:py-8" role="contentinfo">
        <div className="container mx-auto px-4 text-center">
          <div
            className={`flex items-center justify-center ${language === "ar" ? "space-x-reverse space-x-3" : "space-x-3"} mb-4`}
          >
            <div className="flex items-center justify-center">
              <img
                src="/lovable-uploads/5ac7ae81-9a0f-4618-995a-d9837ee86dbf.png"
          ...
          <p className="text-muted-foreground text-xs sm:text-sm">{t("footer.copyright")}</p>
        </div>
      </footer>
    </div>
  );
