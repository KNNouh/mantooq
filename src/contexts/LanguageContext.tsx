...
const translations = {
  ar: {
    ...
    // Hero Section
    'hero.title': 'مرحباً بك في منصة منطق',
    ...
    'about.meaning_title': 'وتحمل تسمية (منطقوق) الدلالات التالية:',
