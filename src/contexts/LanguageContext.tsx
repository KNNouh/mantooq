...
const translations = {
  ar: {
    ...
    'hero.subtitle': 'منصة قانونية متقدمة تعتمد على تقنيات الذكاء الاصطناعي في تحليل وتفسير أحكام قانون تنظيم المناقصات والمزايدات ولائحته التنفيذية في دولة قطر',
