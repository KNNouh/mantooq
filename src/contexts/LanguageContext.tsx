...
const translations = {
  ar: {
    ...
    'hero.subtitle': 'منصة تعتمد على تقنيات الذكاء الاصطناعي في تحليل وتفسير قانون تنظيم المناقصات والمزايدات ولائحته التنفيذية في دولة قطر',
    'hero.description': 'إجابات قانونية موثوقة وفورية تركز على النصوص الرسمية، وتعتمد على تقنيات الذكاء الاصطناعي لضمان الشفافية وتعزيز الامتثال القانوني',
    'hero.start_chat': 'ابدأ المحادثة الآن',
    'hero.learn_more': 'تعرف على المزيد',
    
    // Features
    'features.title': 'منصة مبتكرة تجمع بين المعرفة والتكنولوجيا\n لتوفير مرجع موثوق في قانون المناقصات القطرية',
    'features.subtitle': '',
    ...
    'about.commitment': 'وعليه، فإن اسم (منطوق) يعبر عن التزام المنصة بتقديم المعرفة القانونية وفق أعلى معايير النزاهة والشفافية، وبما يسهم في دعم الجهات الحكومية وأعضاء لجان المناقصات في أداء مهامهم بكفاءة وامتثال تام لأحكام القانون.',
